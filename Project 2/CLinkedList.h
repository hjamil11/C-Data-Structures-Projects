...
{	
    ...
    /* Parameters:    x, element to insert                                   */
    /* Return Value:  none                                                   */
    /*                                                                       */
    /*************************************************************************/
    ...
    else
    {
        ...
        cout << "Else statement has been ran now!" << endl;
    }
}
...
{	
    ...
    /* Parameters:    x, element to remove                                   */
    /* Return Value:  none                                                   */
    /*                                                                       */
    /*************************************************************************/
...
{	
    ...
    /* Parameters:    x, what to search for                                  */
    /* Return Value:  bool                                                   */
    /*                                                                       */
    /*************************************************************************/
    Node<eltType> *p = last->next;
